...
var addButton=document.querySelector(".btn_add");//first button
...
var createNewTaskElement=function(taskString){
  ...
  label.classList='task task__label';

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.classList="task__checkbox"
  editInput.type="text";
  editInput.classList="task task__input";

  editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
  editButton.classList="btn btn_edit";

  deleteButton.classList="btn btn_delete";
